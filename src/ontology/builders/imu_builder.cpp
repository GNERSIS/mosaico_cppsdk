...
void ImuBuilder::initSchema() {
    schema_ = arrow::schema({
        ...
        arrow::field("acceleration", msco::vector3dType()),
        arrow::field("angular_velocity", msco::vector3dType()),
        arrow::field("orientation", msco::quaternionType(), /*nullable=*/true),
...
arrow::Status ImuBuilder::appendRow(const FieldMap& fields) {
    ...
    ARROW_RETURN_NOT_OK(msco::appendVector3d(
    ...
    if (orientation_available &&
        ...
        ARROW_RETURN_NOT_OK(msco::appendQuaternion(
