...
// ---------------------------------------------------------------------------
FieldValue readPrimitive(eprosima::fastcdr::Cdr& cdr,
                         msg::PrimitiveType prim) {
  switch (prim) {
    case msg::PrimitiveType::kBool: {
      bool v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kInt8: {
      int8_t v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kUint8: {
      uint8_t v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kInt16: {
      int16_t v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kUint16: {
      uint16_t v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kInt32: {
      int32_t v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kUint32: {
      uint32_t v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kInt64: {
      int64_t v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kUint64: {
      uint64_t v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kFloat32: {
      float v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kFloat64: {
      double v;
      cdr >> v;
      return v;
    }
    case msg::PrimitiveType::kString:
    case msg::PrimitiveType::kWstring: {
      std::string v;
      cdr >> v;
      return v;
    }
...
// Forward declaration.
arrow::Status decodeField(eprosima::fastcdr::Cdr& cdr,
...
// ---------------------------------------------------------------------------
arrow::Status decodeStructFields(eprosima::fastcdr::Cdr& cdr,
...
// ---------------------------------------------------------------------------
arrow::Status decodeArrayElement(eprosima::fastcdr::Cdr& cdr,
                                 const msg::MsgField& field,
                                 const msg::MsgSchema& parent_schema,
...
arrow::Status CdrDecoder::decode(
  ...
  // Parse the 4-byte CDR encapsulation header to determine endianness.
  auto endian =
  ...
  eprosima::fastcdr::FastBuffer buffer(
      reinterpret_cast<char*>(const_cast<std::byte*>(data + 4)),
      static_cast<size_t>(size - 4));

  eprosima::fastcdr::Cdr cdr(buffer, endian,
                              eprosima::fastcdr::CdrVersion::XCDRv1);

  // Walk msg_schema_ fields, decoding from CDR into FieldMap
  for (const auto& field : msg_schema_->fields) {
    try {
      ARROW_RETURN_NOT_OK(
          decodeField(cdr, field, *msg_schema_, "", out));
    } catch (const eprosima::fastcdr::exception::Exception& ex) {
      return arrow::Status::Invalid(
          std::string("CDR decode error in field '") +
          field.name + "': " + ex.what());
    }
  }
